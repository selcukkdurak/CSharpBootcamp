...
namespace _03_MakingDecision //Karar Yapıları
{
    internal class Program
    {
        ...
        {
            //karar yapılarından sonra noktalama işareti konmaz
            #region If Else
            ...
            //string result; // result = "Hata!"; eğer if else kararları dışında bir sonuç çıkarsa bu mesajı göstericek.
            ...
            //else
            //{
            //    result = "Hata!!! Ortalama değeri 0-100 arasında olmalıdır!";
            //}
            ...
            //else
            //{
            //    Console.WriteLine("Diğer Takımlar");
            //}
            #endregion
            ...
            //Console.Write("Detayını görmek istediğinizi menü seçimi: ");
            ...
            switch (symbol)
            {
                ...
                case '/':
                    ...
                    break;
                default:
                    Console.WriteLine("Hatalı İşlem Girişi");
                    break;
            }
